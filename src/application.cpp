...
Application::Application(int width, int height, const std::string& name)
{
    ...
    shader = new Shader(basePathAssets +"shaders/basic.vert", basePathAssets +"shaders/basic.frag");
    lightShader = new Shader(basePathAssets +"shaders/light.vert", basePathAssets +"shaders/light.frag");
    outlineShader = new Shader(basePathAssets +"shaders/light.vert", basePathAssets +"shaders/outline.frag");
    postprocessing =
        new Shader(basePathAssets +"shaders/postprocessing.vert", basePathAssets +"shaders/postprocessing.frag");
    cube = new Model(basePathAssets + "sponza/sponza.obj");
    light = new Model(basePathAssets +"cube/cube.obj");
    camera = new Camera();
}
