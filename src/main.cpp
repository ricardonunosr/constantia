...
int main(void)
{
  ...
  unsigned int indices[] = {
    ...
    std::unique_ptr<Texture> texture1 = std::make_unique<Texture>("../data/container.jpg");
    std::unique_ptr<Texture> texture2 = std::make_unique<Texture>("../data/awesomeface.png", true);
